...
Ground-truth classification supplied by the dataset (do not repeat it as output fields):
- product: {{ product }}
...
- The assistant must not guarantee an outcome, promise a deadline, give legal conclusions, cite statutes,
